<script lang="ts">
	...
	import { faHouse, faImage, faBoxOpen, faCoins, faWifi, faChessBoard, faCog, faCubes, faCube, faImages, faShareNodes, faLayerGroup } from '@fortawesome/free-solid-svg-icons';
...
<nav class="list-nav p-4">
	<ul class="flex gap-2 flex-col">
		...
		<li class="flex items-center"><Fa icon={faCog} /><a class="fa-solid fa-gear" on:click={drawerClose} href="/settings">Settings</a></li>
	</ul>
</nav>
